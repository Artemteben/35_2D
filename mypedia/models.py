...
class Lesson(models.Model):
    ...
    course = models.ForeignKey(
        Course, on_delete=models.CASCADE, verbose_name="Курс", null=True, blank=True, related_name="lessons"
    )
    owner = models.ForeignKey(
        get_user_model(),
        on_delete=models.SET_NULL,
...
class Subscription(models.Model):
    ...
    owner = models.ForeignKey(
        get_user_model(), on_delete=models.CASCADE, verbose_name="Пользователь", related_name="subscriptions"
    )
